...
@property (nonatomic, retain) NSArray *dayButtons;
@property (nonatomic, retain) NSArray *notThisMonthButtons;
...
@property (nonatomic, retain) NSDateFormatter *accessibilityFormatter;
