 ...
 */
@property (nonatomic, assign, readonly) UIImage *backgroundImage;
 ...
 */
@property (nonatomic, assign, readonly) UIImage *selectedBackgroundImage;
 ...
 */
@property (nonatomic, assign, readonly) UIImage *todayBackgroundImage;
 ...
 */
@property (nonatomic, assign, readonly) UIImage *notThisMonthBackgroundImage;
 ...
 */
@property (nonatomic, retain) NSDate *beginningDate;
